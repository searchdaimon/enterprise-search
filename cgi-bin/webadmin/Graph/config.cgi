...
<settings> 
  <type>$type</type>                                               <!-- [column] (column / bar) -->
  ...
  <angle>20</angle>                                           <!-- [30] (0 - 90) angle of chart area and columns (for 3D effect) -->
  ...
  <column>
    ...
    <balloon_text>                                                    
      <![CDATA[{series}: {value}]]>                           <!-- [] ({title} {value} {series} {percents} {start} {difference} {total}) You can format any data label: {title} will be replaced with real title, {value} - with value and so on. You can add your own text or html code too. -->
    </balloon_text>    
  ...
  <plot_area>                                                 <!-- PLOT AREA (the area between axes) -->
    ...
    <margins>                                                 <!-- plot area margins -->
      <left>$leftmargin</left>                                         <!-- [60](Number / Number%) --> 
  ...
  <values>                                                    <!-- VALUES -->
    <category>                                                <!-- category axis -->
      ...
      <frequency>$frequency</frequency>                                 <!-- [1] (Number) how often values should be placed -->
      <start_from></start_from>                               <!-- [1] (Number) you can set series from which category values will be displayed -->
      <rotate>$rotate</rotate>                                       <!-- [0] (0 - 90) angle of rotation. If you want to rotate by degree from 1 to 89, you must have font.swf file in fonts folder -->      
  ...
  <axes>                                                      <!-- axes -->
    <category>                                                <!-- category axis -->
      ...
      <tick_length>2</tick_length>                             <!-- [7] (Number) -->
    </category>
    <value>                                                   <!-- value axis -->
      <color></color>                                         <!-- [#000000] (hex color code) -->
      <alpha></alpha>                                         <!-- [100] (0 - 100) -->
  ...
  <balloon>                                                   <!-- BALLOON -->
    <enabled></enabled>                                       <!-- [true] (true / false) -->
    <color>#044a90</color>                                           <!-- [] (hex color code) balloon background color. If empty, slightly darker then current column color will be used -->
    <alpha></alpha>                                           <!-- [100] (0 - 100) -->
...
<settings> 
  ...
  <redraw>$redrawline</redraw>                                           <!-- [false] (true / false) if your chart's width or height is set in percents, and redraw is set to true, the chart will be redrawn then screen size changes -->
                                                              <!-- Legend, buttons labels will not be repositioned if you set your x and y values for these objects -->  
  <reload_data_interval>$reload_data_interval</reload_data_interval>               <!-- [0] (Number) how often data should be reloaded (time in seconds) If you are using this feature I strongly recommend to turn off zoom function (set <zoomable>false</zoomable>) -->
  <preloader_on_reload></preloader_on_reload>                 <!-- [false] (true / false) Whether to show preloaded when data or settings are reloaded -->
  ...
  <values>                                                    <!-- VALUES -->
    <x>                                                       <!-- x axis -->
      <enabled></enabled>                                     <!-- [true] (true / false) -->
      <rotate>$rotate</rotate>                                       <!-- [0] (0 - 90) angle of rotation. If you want to rotate by degree from 1 to 89, you must have font.swf file in fonts folder -->      
      <frequency>$frequency</frequency>                                 <!-- [1] (Number) how often values should be placed, 1 - near every gridline, 2 - near every second gridline... -->
    ...
    <y_left>                                                  <!-- y left axis -->
      ...
      <reverse></reverse>                                     <!-- [false] (true / false) whether to reverse this axis values or not. If set to true, values will start from biggest number and will end with a smallest number -->    
      <rotate></rotate>                                       <!-- [0] (0 - 90) angle of rotation. If you want to rotate by degree from 1 to 89, you must have font.swf file in fonts folder -->
      <min>$linemin</min>                                             <!-- [] (Number) minimum value of this axis. If empty, this value will be calculated automatically. -->
      <max></max>                                             <!-- [] (Number) maximum value of this axis. If empty, this value will be calculated automatically -->
      <strict_min_max></strict_min_max>                       <!-- [false] (true / false) by default, if your values are bigger then defined max (or smaller then defined min), max and min is changed so that all the chart would fit to chart area. If you don't want this, set this option to true. -->
      <frequency></frequency>                                 <!-- [1] (Number) how often values should be placed, 1 - near every gridline, 2 - near every second gridline... -->
      <skip_first></skip_first>                               <!-- [true] (true / false) to skip or not first value -->
  ...
  <indicator>                                                 <!-- INDICATOR -->
    ...
    <color>#044a90</color>                                           <!-- [#BBBB00] (hex color code) line and x balloon background color -->
    <line_alpha></line_alpha>                                 <!-- [100] (0 - 100) -->
    <selection_color>#e7f3fb</selection_color>                       <!-- [#BBBB00] (hex color code) -->
  ...
  <help>                                                      <!-- HELP button and balloon -->  
    <button>                                                  <!-- help button is only visible if balloon text is defined -->
      ...
      <text_color_hover>044a90</text_color_hover>                   <!-- [#BBBB00](hex color code) button text roll over color -->    
  ...
  <graphs>                                                    <!-- GRAPHS SETTINGS. These settings can also be specified in data file, as attributes of <graph>, in this case you can delete everything from <graphs> to </graphs> (including) -->
    ...
    <graph gid="0">                                           <!-- if you are using XML data file, graph "gid" must match graph "gid" in data file -->
      ...
      <color>#044a90</color>                                  <!-- [] (hex color code) if not defined, uses colors from this array: #FF0000, #0000FF, #00FF00, #FF9900, #CC00CC, #00CCCC, #33FF00, #990000, #000066 -->
      <color_hover>#064c92</color_hover>                             <!-- [#BBBB00] (hex color code) -->
