...
enum parsed_unit
{
    pu_none, pu_word, pu_link, pu_baselink, pu_linkword, pu_meta_keywords, pu_meta_author, pu_meta_description, pu_meta_redirect, pu_cloaked_word, pu_cloaked_linkword
};
