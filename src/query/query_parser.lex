...
%x PHRASE CMD
%%
\+?[dD][aA][tT][eE]{space}*:	{ yyget_extra(yyscanner)->operand = 'd'; }
\+?[sS][tT][aA][tT][uU][sS]{space}*:	{ yyget_extra(yyscanner)->operand = 's'; }
\+?[fF][iI][lL][eE][tT][yY][pP][eE]{space}*:	{ yyget_extra(yyscanner)->operand = 'f'; }
\+?[lL][aA][nN][gG][uU][aA][gG][eE]{space}*:	{ yyget_extra(yyscanner)->operand = 'l'; }
\+?[cC][oO][lL][lL][eE][cC][tT][iI][oO][nN]{space}*:	{ yyget_extra(yyscanner)->operand = 'c'; }
\+?[sS][oO][rR][tT]{space}*: { yyget_extra(yyscanner)->operand = 'k'; }
\+?[gG][rR][oO][uU][pP]{space}*: { yyget_extra(yyscanner)->operand = 'g'; }
