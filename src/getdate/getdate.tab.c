...
#line 167 "getdate.y"
    {
	    yyvars->yyYear = (yyvsp[-10].Number);
	    if (yyvars->yyYear < 100) yyvars->yyYear += 1900;
	    yyvars->yyMonth = (yyvsp[-8].Number);
	    yyvars->yyDay = (yyvsp[-6].Number);
	    yyvars->yyHour = (yyvsp[-4].Number);
	    yyvars->yyMinutes = (yyvsp[-2].Number);
	    yyvars->yySeconds = (yyvsp[0].Number);
...
#line 180 "getdate.y"
    {
	    yyvars->yyHour = (yyvsp[-1].Number);
	    yyvars->yyMinutes = 0;
	    yyvars->yySeconds = 0;
	    yyvars->yyMeridian = (yyvsp[0].Meridian);
	;}
    break;
...
#line 186 "getdate.y"
    {
	    yyvars->yyHour = (yyvsp[-3].Number);
	    yyvars->yyMinutes = (yyvsp[-1].Number);
	    yyvars->yySeconds = 0;
	    yyvars->yyMeridian = (yyvsp[0].Meridian);
	;}
    break;
...
#line 192 "getdate.y"
    {
	    ...
	    yyvars->yyDSTmode = DSToff;
	    yyvars->yyTimezone = - ((yyvsp[0].Number) % 100 + ((yyvsp[0].Number) / 100) * 60);
	;}
    break;
...
#line 199 "getdate.y"
    {
	    yyvars->yyHour = (yyvsp[-5].Number);
	    yyvars->yyMinutes = (yyvsp[-3].Number);
	    yyvars->yySeconds = (yyvsp[-1].Number);
	    yyvars->yyMeridian = (yyvsp[0].Meridian);
	;}
    break;
...
#line 215 "getdate.y"
    {
	    yyvars->yyTimezone = (yyvsp[0].Number);
	    yyvars->yyDSTmode = DSToff;
	;}
    break;
...
#line 224 "getdate.y"
    {
	    yyvars->yyTimezone = (yyvsp[-1].Number);
	    yyvars->yyDSTmode = DSTon;
	;}
    break;
...
#line 230 "getdate.y"
    {
	    ...
	    yyvars->yyDayNumber = (yyvsp[0].Number);
	;}
    break;
...
#line 234 "getdate.y"
    {
	    yyvars->yyDayOrdinal = 1;
	    yyvars->yyDayNumber = (yyvsp[-1].Number);
	;}
    break;
...
#line 238 "getdate.y"
    {
	    yyvars->yyDayOrdinal = (yyvsp[-1].Number);
	    yyvars->yyDayNumber = (yyvsp[0].Number);
	;}
    break;
...
#line 244 "getdate.y"
    {
	    yyvars->yyMonth = (yyvsp[-2].Number);
	    yyvars->yyDay = (yyvsp[0].Number);
	;}
    break;
...
#line 248 "getdate.y"
    {
		...
		yyvars->yyYear = (yyvsp[-4].Number);
		yyvars->yyMonth = (yyvsp[-2].Number);
		yyvars->yyDay = (yyvsp[0].Number);
	    } else {
		yyvars->yyMonth = (yyvsp[-4].Number);
		yyvars->yyDay = (yyvsp[-2].Number);
		yyvars->yyYear = (yyvsp[0].Number);
	    }
	;}
    break;
...
#line 259 "getdate.y"
    {
	    ...
	    yyvars->yyYear = (yyvsp[-2].Number);
	    yyvars->yyMonth = -(yyvsp[-1].Number);
	    yyvars->yyDay = -(yyvsp[0].Number);
	;}
    break;
...
#line 280 "getdate.y"
    {
	    yyvars->yyMonth = (yyvsp[0].Number);
	    yyvars->yyDay = (yyvsp[-1].Number);
	;}
    break;
...
#line 298 "getdate.y"
    {
	    yyvars->yyRelSeconds += (yyvsp[-1].Number) * (yyvsp[0].Number) * 60L;
	;}
    break;
...
#line 304 "getdate.y"
    {
	    yyvars->yyRelSeconds += (yyvsp[0].Number) * 60L;
	;}
    break;
...
#line 307 "getdate.y"
    {
	    yyvars->yyRelSeconds += (yyvsp[-1].Number);
	;}
    break;
...
#line 316 "getdate.y"
    {
	    yyvars->yyRelMonth += (yyvsp[-1].Number) * (yyvsp[0].Number);
	;}
    break;
...
#line 322 "getdate.y"
    {
	    yyvars->yyRelMonth += (yyvsp[0].Number);
	;}
    break;
...
#line 327 "getdate.y"
    {
		...
		if((yyvsp[0].Number)>10000) {
		    yyvars->yyHaveDate++;
		    yyvars->yyDay= ((yyvsp[0].Number))%100;
		    yyvars->yyMonth= ((yyvsp[0].Number)/100)%100;
		    yyvars->yyYear = (yyvsp[0].Number)/10000;
		}
		else {
		    yyvars->yyHaveTime++;
		    if ((yyvsp[0].Number) < 100) {
			yyvars->yyHour = (yyvsp[0].Number);
			yyvars->yyMinutes = 0;
		    }
		    else {
		    	yyvars->yyHour = (yyvsp[0].Number) / 100;
		    	yyvars->yyMinutes = (yyvsp[0].Number) % 100;
		    }
		    yyvars->yySeconds = 0;
		    yyvars->yyMeridian = MER24;
	        }
